...
function handleRewardAndCheck(studentId) {
    ...
    console.log('检查升级:', student.name, '爱心数:', student.collectedPlants.length, '当前等级:', student.petLevel, 'LV2门槛:', PET_LEVEL_2_THRESHOLD, 'LV3门槛:', PET_LEVEL_3_THRESHOLD);
